...
function Projects() {
  return (
    <Layout>
      ...
      <div className="mx-20 mt-10 grid grid-cols-3 items-center justify-center gap-10 md:mx-5 md:grid-cols-1">
            ...
            <div key={index}>
              <div className="relative rounded-bl-3xl rounded-tr-3xl border-2 border-black text-center">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center rounded-bl-3xl rounded-tr-3xl bg-black opacity-0 hover:opacity-80">
                  ...
                  <button className="hover:bg-indian-red mt-5 rounded border-2 border-white px-5 py-2 text-white">
                    DEMO
                  </button>
                </div>
              </div>
